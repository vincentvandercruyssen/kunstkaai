...
Zorg dat in de map `VoornaamA_Recept` de volgende bestanden zitten:

- **index.html** en **style.css**.
- Afbeeldingen in de map **images**.

Zorg voor een koppekling naar je volledige vakmap in je OneDrive.

## Puntenverdeling

- **Structuur (05)** `VoornaamA_Recept` met `index.html`, `style.css` en één map met afbeeldingen.
