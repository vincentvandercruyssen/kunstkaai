...
#### E-mail en de groei van het internet
...
{{< img src="img/web/de-uitvinding-van-het-world-wide-web-04.png" width="800" >}}

#### W3C: Standaardisatie van het Web

In 1994 werd het World Wide Web Consortium (W3C) opgericht om de organisatie, groei en ontwikkeling van het web te waarborgen. Onder leiding van Tim Berners-Lee, de uitvinder van het World Wide Web, heeft deze organisatie zich ingezet voor het opstellen van essentiële webstandaarden en richtlijnen. Dit zorgt ervoor dat het web wereldwijd op een uniforme en gestandaardiseerde manier functioneert, waardoor webbrowsers en webservers naadloos kunnen samenwerken.


{{< svg src="img/web/w3c-logo.svg" >}}

#### Snelle uitbreiding in de jaren 1990

Nadat de initiële infrastructuur eenmaal was opgezet en de belangrijkste technologieën waren ontwikkeld, zagen we een explosieve groei van internetfora in de jaren tachtig en negentig. Telecommunicatiebedrijven zagen het commerciële potentieel van digitale communicatie in. Met de opkomst van webbrowsers aan het begin van de jaren negentig en de popularisering van e-mail, breidde het internet zich in een hoog tempo uit. Rond 1995 werd het internet toegankelijk voor het brede publiek en ging het mainstream.

Het internet ontstond uit de menselijke behoefte om te communiceren. Hoewel het niet kan worden toegeschreven aan één specifieke persoon of land, was de bijdrage van talloze wetenschappers wereldwijd van essentieel belang voor de ontwikkeling. Het is uitgegroeid tot een onmisbaar instrument in onze hedendaagse wereld en blijft evolueren.

{{< youtube UlJku_CSyNg >}}

{{< youtube 21eFwbb48sE >}}

### Opkomst van webbrowsers en webtechnologie

Na de introductie van het World Wide Web door Tim Berners-Lee, werd het essentieel om een manier te hebben voor gewone mensen om webpagina's te bekijken en door het web te navigeren. Hier kwamen webbrowsers in beeld. Deze softwaretoepassingen stelden gebruikers in staat om webpagina's te bekijken, hyperlinks te volgen en interactie te hebben met online content. De eerste browsers waren relatief eenvoudig, maar ze legden de basis voor de meer geavanceerde browsers die we vandaag de dag gebruiken, zoals Google Chrome, Mozilla Firefox en Microsoft Edge. Met de beschikbaarheid van browsers werd het internet toegankelijker voor het grote publiek en begon het zijn explosieve groei.

|   |   |
|---|---|
| {{< img src="img/web/worldwideweb-nexus-01.png" width="800" >}} | **WorldWideWeb, later Nexus (1990)** De allereerste webbrowser en webeditor. Ontworpen door Tim Berners-Lee, de uitvinder van het World Wide Web. |
| {{< img src="img/web/ncsa_mosaic-logo.png" width="800" >}}  | **NCSA Mosaic (1993)** wordt vaak beschouwd als de eerste 'populaire' browser. Vóór de introductie van Mosaic waren webbrowsers voornamelijk tekstgebaseerd, maar deze introduceerde een grafische interface die het web toegankelijker maakte voor het grote publiek. |
| {{< svg src="img/web/netscape-logo.svg" >}} | **Netscape Navigator (1994)** werd opgericht door voormalige leden van het Mosaic-team en werd al snel de dominante browser in het midden van de jaren '90. |
| {{< svg src="img/web/internet_explorer-logo.svg" >}} | **Microsoft Internet Explorer (1995)** werd al snel marktleider, vooral vanwege de integratie met het Windows-besturingssysteem. Het ging de strijd aan in de zogenaamde "browseroorlogen" met Netscape en behaalde uiteindelijk een marktaandeel van meer dan 90%. |
| {{< svg src="img/web/opera-logo.svg" >}}  | **Opera (1995)** heeft nooit het marktaandeel van Netscape of IE geëvenaard, maar was wel zeer innovatief. Het introduceerde vele functies die later standaard werden in andere browsers, zoals tabbladen en ingebouwde zoekfuncties. |
| {{< svg src="img/web/firefox-logo.svg" >}} | **Mozilla Firefox (2002)** kwam voort uit het Mozilla-project dat oorspronkelijk werd gestart door Netscape. Firefox bood een sneller, veiliger en opener alternatief voor Internet Explorer en heeft bijgedragen aan het doorbreken van de bijna-monopoliepositie van IE in de vroege jaren 2000. |
| {{< svg src="img/web/safari-logo.svg" >}} | **Apple Safari (2003)** werd geïntroduceerd als de standaardbrowser voor Mac OS X en legde de focus op snelheid en een minimalistische gebruikersinterface. |
| {{< svg src="img/web/chrome-logo.svg" >}} | **Google Chrome (2008)** legde de nadruk op snelheid, veiligheid en een overzichtelijke interface. De browser introduceerde ook het concept waarbij elke tab als een afzonderlijk proces werd beschouwd, wat de stabiliteit en veiligheid ten goede kwam. Binnen enkele jaren na de lancering overtrof Chrome zowel Firefox als IE en werd het 's werelds meest gebruikte browser. |
| {{< svg src="img/web/chromium-logo.svg" >}} | Veel huidige browsers zijn gebaseerd op **Chromium (2008)**, een open-source webbrowserproject dat dient als fundament voor verschillende browsers, waaronder Google Chrome als de bekendste. Hoewel het project door Google wordt beheerd, stelt de open-source aard ervan iedereen in staat om de code te bekijken, te wijzigen en eigen versies te ontwikkelen. Naast Google Chrome zijn er tal van browsers die gebruikmaken van de Chromium-codebasis. Voorbeelden hiervan zijn Microsoft Edge (de vernieuwde versie uit 2019), Brave, Opera (vanaf versie 15) en vele andere. |
| {{< svg src="img/web/edge-logo.svg" >}} | **Microsoft Edge (2015)** is de opvolger van Internet Explorer. |

#### HTML: Navigeren op het web wordt toegankelijker
...
#### Responsive Webdesign voor diverse apparaten
...
17. **CSS (Cascading Style Sheets)** (1996): Deze stijltaal voor webdocumenten werd in 1996 geïntroduceerd.
...
UI, of gebruikersomgeving, richt zich op hoe een product eruit ziet en hoe een gebruiker ermee omgaat. Dit omvat de lay-out, knoppen, kleuren, typografie en visuele elementen die een gebruiker tegenkomt bij het gebruik van een applicatie of website. Gebruikersomgeving gaat voornamelijk over grafisch ontwerp en vormgeving van tekst en beeld.
